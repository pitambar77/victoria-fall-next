...
const Page = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`${process.env.NEXT_PUBLIC_API_BASE}/api/activitylanding/${id}`);
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold">Activity Landing Page</h2>

        <button
          onClick={() => router.push("/dashboard/activity-landing/create")}
                ...
                <tr key={item._id}>
                  ...
                  <td className="border p-3">
                    <div className="flex gap-2 justify-center flex-wrap">
                      ...
                      <button
                        onClick={() =>
                          router.push(`/dashboard/activity-landing/${item._id}`)
                        }
