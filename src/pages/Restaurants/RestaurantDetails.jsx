...
//     axios
//       .get(`${process.env.NEXT_PUBLIC_API_URL}/restaurants/slug/${slug}`)
...
//         <p>
//           <strong>Address 1:</strong> {restaurant.address1}
//         </p>
//         <p>
//           <strong>Address 2:</strong> {restaurant.address2}
//         </p>
//         <p>
//           <strong>Contact:</strong> {restaurant.contactNumber}
//         </p>
//         <p>
//           <strong>Opening Time:</strong> {restaurant.openingTime} AM
//         </p>
//         <p>
//           <strong>Closing Time:</strong> {restaurant.closingTime} PM
//         </p>
//         <p>
//           <strong>Price per Person:</strong> ₹{restaurant.priceperPerson}
//         </p>
//       </div>
...
//               <h3 className="text-xl font-semibold mb-3 border-b border-gray-200 pb-1">
...
//                     </div>
//                     <p className="text-white/80 text-sm">{item.ingredients}</p>
//                   </div>
//                 ))}
//               </div>
//             </div>
