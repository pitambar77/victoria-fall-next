...
const ActivityLandingForm = ({ editData, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editData) {
        res = await axios.put(
          `${process.env.NEXT_PUBLIC_API_BASE}/api/activitylanding/${editData._id}`,
          data,
        );
      } else {
      ...
      router.push("/dashboard/activity-landing");
...
export default ActivityLandingForm;
